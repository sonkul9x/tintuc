					...
					<div class="tab_container">
					     <div id='tab1' class="tab_content pd0">
							...
							<div class="formRow">
								...
								<img src="<?php echo base_url('upload/slide/'.$slide->image_link); ?>" style="width: 100px;height: 50px;" alt="">
								<?php } ?>
							 ...
							 <div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><input name="image_name" id="param_image_name" value="<?php echo $slide->image_name; ?>" _autocheck="true" type="text" /></span>
							...
							<div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><textarea name="info" id="param_info" rows="4" cols=""><?php echo $slide->info; ?></textarea></span>
							 ...
							 <div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><input style="width: 50px;" name="sort_order" id="param_sort_order"  value="<?php echo $slide->sort_order; ?>" _autocheck="true" type="text" /></span>
