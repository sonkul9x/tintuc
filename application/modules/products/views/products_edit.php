...
<div class="wrapper">
	...
	<div class="formRight">
		<span class="oneTwo"><input name="name" id="param_name" _autocheck="true" value="<?php echo $product->name; ?>" type="text" /></span>
...
<div class="formRow">
	...
	<div class="formRight">
		<div class="left"  style="margin-right:15px;"><input type="file"  id="image" name="image"  ></div>
		<img src="<?php echo base_url('upload/product/'.$product->image_link); ?>" style="width: 100px;height: 50px;" alt="">
...
<div class="formRow">
	...
	<div class="formRight">
		<span>
			<input name="discount"  style='width:100px' id="param_discount" class="format_number" value="<?php echo $product->discount; ?>"  type="text" />
									...
									<?php foreach ($catalogs as $vcatalog) {
									     ...
									     <optgroup label="<?php echo $vcatalog->name; ?>">
											<?php foreach ($vcatalog->subs as $value) { ?>											
									       		<option value="<?php echo $value->id; ?>" <?php echo ($value->id == $product->catalog_id) ? 'selected' : ''; ?> ><?php echo $value->name; ?> </option>
											<?php }; ?>
									     </optgroup>
									     <?php }else{ ?>
									     	<option value="<?php echo $vcatalog->id; ?>" <?php echo ($value->id == $product->catalog_id) ? 'selected' : ''; ?>><?php echo $vcatalog->name; ?></option>
									     <?php } ?>
									<?php } ?>
